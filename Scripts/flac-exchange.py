...
def main(
    ...
    :param str out_type:            The format to convert FLAC into, either MP3 or AIFF.
    :param Iterable[str] src_dirs:  One or more directories to clone and convert.
    :param bool force:              Whether or not output directories should be overwritten if they already exist.
    ...
    for src, out in zip(src_dirs, out_dirs):
        ...
        while not done:
            try:
                ...
                file = stdout if force else stderr
                ...
                if force:
                    ...
                    print("\nRefusing to overwrite output directory without force flag.", file=stderr)
                    return 1
        del done
